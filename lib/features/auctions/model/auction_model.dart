import 'auction_event_model.dart';
...
class AuctionModel {
  ...
  final List<AuctionEventModel> events;
  const AuctionModel({
    required this.id,
    required this.title,
  ...
  factory AuctionModel.fromJson(Map<String, dynamic> json) {
    ...
    final events = (json['events'] as List<dynamic>? ?? [])
        .map((e) => AuctionEventModel.fromJson(e as Map<String, dynamic>))
        .toList();
    ...
    return AuctionModel(
      ...
      paymentDeadlineDays: json['payment_deadline_days'] as int?,
      autoExtendEnabled: json['auto_extend_enabled'] as bool? ?? false,
      autoExtendMinutes: json['auto_extend_minutes'] as int?,
