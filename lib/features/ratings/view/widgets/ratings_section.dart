...
class _RatingBottomSheet extends StatefulWidget {
  ...
  const _RatingBottomSheet({required this.targetType, required this.targetId});
...
class _CommentBottomSheet extends StatefulWidget {
  ...
  const _CommentBottomSheet({required this.targetType, required this.targetId});
