      ...
      children: [
        ...
        Positioned(
          ...
          child: BlocBuilder<MarketBloc, MarketState>(
            buildWhen: (p, c) =>
                p.selectedProduct?.isFavorite !=
                c.selectedProduct?.isFavorite,
              ...
              Row(
                children: [
                  _StepBtn(
                    ...
                    onTap: () => context
                        .read<MarketBloc>()
                        .add(const MarketQuantityDecreased()),
                  ),
                  Container(
                    width: 48,
                  ...
                  _StepBtn(
                    ...
                    onTap: () => context
                        .read<MarketBloc>()
                        .add(const MarketQuantityIncreased()),
                  ),
                ],
              ),
            ],
          ...
          Expanded(
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  context.read<MarketBloc>().add(const MarketAddToCart());
